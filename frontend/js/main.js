...
var main = function (_, Kotlin, $module$kotlinx_html_js) {
  ...
  TodoEventEmitter.prototype.on_8sfohe$ = function (eventName, callback) {
    var tmp$;
  ...
  TodoEventEmitter.prototype.trigger_wq4upj$ = function (eventName, task) {
    var tmp$;
    if (this.events_0.containsKey_11rb$(eventName)) {
  ...
  Ajax.prototype.post_ihwyc9$ = function (url, task, callback) {
  ...
  function StorageService(eventEmitter) {
    ...
    this.eventEmitter.on_8sfohe$(this.addEvent, StorageService_init$lambda);
    this.eventEmitter.on_8sfohe$(this.doneEvent, StorageService_init$lambda_0(this));
    this.eventEmitter.on_8sfohe$(this.undoneEvent, StorageService_init$lambda_1(this));
  }
  function StorageService$getAll$lambda(this$StorageService, closure$callback) {
    return function (it) {
      ...
      for (tmp$ = 0; tmp$ !== tasks.length; ++tmp$) {
        ...
        var key = element.id;
        this$StorageService_0.put_xwzc9p$(key, element);
      }
      closure$callback();
      return Unit;
    };
  ...
  StorageService.prototype.update_9j7nl1$ = function (task) {
    return (new Ajax()).post_ihwyc9$('/task/' + task.id, task, StorageService$update$lambda);
  };
  StorageService.prototype.put_xwzc9p$ = function (key, value) {
    this.eventEmitter.trigger_wq4upj$(this.addEvent, value);
  ...
  function StorageService_init$lambda_0(this$StorageService) {
    return function (it) {
      ...
      this$StorageService.update_9j7nl1$(it);
      return Unit;
    };
  }
  ...
  function markAsDone$lambda(closure$task, closure$storage) {
    return function (it) {
      ...
      if (!checkbox.checked) {
        ...
        closure$storage.eventEmitter.trigger_wq4upj$(closure$storage.doneEvent, closure$task);
      }
       else {
        closure$task.isDone = false;
        title.style.textDecoration = 'none';
        closure$storage.eventEmitter.trigger_wq4upj$(closure$storage.undoneEvent, closure$task);
      }
      return Unit;
    };
  }
  ...
  var package$events = package$example.events || (package$example.events = {});
  package$events.TodoEventEmitter = TodoEventEmitter;
  package$example.main_kand9s$ = main;
  var package$model = package$example.model || (package$example.model = {});
  package$model.Task = Task;
  var package$services = package$example.services || (package$example.services = {});
  package$services.Ajax = Ajax;
  package$services.StorageService = StorageService;
  var package$views = package$example.views || (package$example.views = {});
  package$views.Todo = Todo;
  package$views.listView_gk4mc5$ = listView;
  package$views.todoItem_39b4ue$ = todoItem;
  package$views.checkTaskIsDone_9j7nl1$ = checkTaskIsDone;
  package$views.markAsDone_abax76$ = markAsDone;
